    ...
    while True:
        if opcao == 1:
            ...
            try:
                ...
                while opcao2 not in "sn":
                    print("opcão inválida")
                    opcao2 = str(input(f"Fazer outra operação de subtração? [S/N]")).lower()
                if opcao2 == "n":
                    break
            except Exception as e:
                print(e)
            ...
            try:
                ...
                opcao2 = input("Fazer outra operação de multiplicação? [S/N]").lower()
                while opcao2 not in "sn":
                    print("opcão inválida")
                    opcao2 = str(input(f"Fazer outra operação de multiplicação? [S/N]")).lower()
                if opcao2 == "n":
                    break
            except Exception as e:
                print(e)
            ...
            try:
                ...
                while opcao2 not in "sn":
                    print("opcão inválida")
                    opcao2 = str(input(f"Fazer outra operação de divisão? [S/N]")).lower()
                if opcao2 == "n":
                    break
            except Exception as e:
                print(e)
