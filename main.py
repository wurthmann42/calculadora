    ...
    while True:
        if opcao == 1:
            try:
                ...
                print(f"O resultado da soma dos números fornecidos é: {c.soma(*numeros_inteiros)}")
            ...
            try:
                numeros_inteiros = numeros_para_int()
                print(f"O resultado da subtração dos números fornecidos é: {c.subtrai(*numeros_inteiros)}")
            ...
            try:
                numeros_inteiros = numeros_para_int()
                print(f"O resultado da multiplicação dos números fornecidos é: {c.multiplica(*numeros_inteiros)}")
